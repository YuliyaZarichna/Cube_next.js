    ...
    <div className="timeline">
      ...
      <div className="entry">
        ...
        <div className="right">
          ...
          <p className="rightDescription">
            ...
            standard model of information for the residents of the dormitories.
            The goal was to connect all dormitory residents and bring them on a
            platform to interact and exchange information with each other.
          </p>
        </div>
      </div>
      ...
      <div className="entry">
        ...
        <div className="right">
          ...
          <p>
            <span>Focus: </span>Prepress, Layout and editing, Color reproduction
          </p>
        </div>
      </div>
    </div>
